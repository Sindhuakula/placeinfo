...
<div class="w3-top">
  <div class="w3-bar w3-black w3-padding-large">
    ...
    <div class="w3-display-left w3-small" style="padding:16px 16px">
    	<a href="main.jsp" class="w3-bar-item w3-padding-large"><img src="./images/logo.png" style="width:170px"></a>
    </div>
    <div class="w3-display-middle w3-large">
    	<a href="main.jsp" class="w3-bar-item w3-padding-large"><b>PlaceInfo</b></a>
    </div>
